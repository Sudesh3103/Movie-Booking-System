     ...
     <section>
      <div class="container mb-3">
        <div class="d-flex justify-content-between align-items-center p-2">
          <div>
            <h3 class="mb-2 mt-3">All Movies</h3>
          </div>
        </div>
        ...
        <div class="row g-4">
         ...
         <% 
            ...
            try {
                ...
                ResultSet rs = stmt.executeQuery("SELECT * FROM allmovies");
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="card movie-card">
                    ...
                    <div class="card-body">
                       ...
                       <button class="btn btn-primary m-auto d-block"> <a href="AllMovieDetails.jsp?id=<%= rs.getInt("id") %>" class="text-decoration-none text-white">View</a></button>
                    </div>
                </div>
            </div>
