...
<%
    ...
    try {
        ...
        PreparedStatement ps = conn.prepareStatement("SELECT * FROM upcomingmovies WHERE id = ?");
        ps.setInt(1, movieId);
                ...
                <div class="col-12 col-md-7 col-lg-8 pt-4">
                    <div class="text-white pt-5 text">
                        ...
                        <div class="bg-dark text-white w-75 p-2 mb-3">
                            <h5> <i class="bi bi-star-fill text-warning"></i> 8/10 (10.5K Votes)</h5>
                        </div>
